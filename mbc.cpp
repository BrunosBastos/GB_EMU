...
*/
MemoryController0::MemoryController0(Cartridge *cart) : MemoryController(cart){};
...
/*
	Memory Controller 1
*/
MemoryController1::MemoryController1(Cartridge *cart) : MemoryController(cart){};
...
/*
	Memory Controller 2
*/
MemoryController2::MemoryController2(Cartridge *cart) : MemoryController(cart){};
...
/*
	Memory Controller 3
*/
MemoryController3::MemoryController3(Cartridge *cart) : MemoryController(cart){};
